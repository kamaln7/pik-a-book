 ...
 */
@WebListener
public class CreateTables2_copy implements ServletContextListener {

	/**
	 * Default constructor.
	 */
	public CreateTables2_copy() {
...
//				// conn.prepareStatement(AppConstants.INSERT_CUSTOMER_STMT);
...
//		}
	...
	/**
	 * Loads customers data from json file that is read from the input stream into a
	 ...
	 * @throws IOException
	 */
	private Collection<User> loadCustomers(InputStream is) throws IOException {
		...
		Collection<User> customers = gson.fromJson(jsonFileContent.toString(), type);
		// close
		br.close();
		return customers;
